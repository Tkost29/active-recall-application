    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'あなたは教育アプリケーションのための問題作成者です。提供された用語名について、学習者にその用語の意味や内容を説明させる問題を作成してください。問題文は必ず「〇〇について説明してください」という形式にしてください。重要: 用語の説明や答えのヒントになる内容は絶対に問題文に含めないでください。'
          },
          {
            role: 'user',
            content: `以下の用語について説明を記述させる問題を作成してください。\n\n${terms}\n\n注意事項：\n1. 問題文は「〇〇について説明してください。」という形式で出力してください\n2. 用語の説明内容やヒントは一切含めないでください\n3. 用語名のみを使って問題を作成してください`
          }
        ],
        temperature: 0.7,
        max_tokens: 500
